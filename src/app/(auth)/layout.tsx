...
export default function AuthLayout ({
    ...
    return (
        ...
        <div className='grid min-h-screen w-full grid-cols-1 md:grid-cols-2'>
            ...
            <div className='relativez-20 hidden w-full items-center justify-center
            overflow-hidden border-1 border-neutral-100 bg-gray-50 dark:border-netural-800
            dark:bg-muted/40 md:flex'
                 >
                ...
                <div className='mx-auto max-w-sm'>
                    ...
                    <p className={cn(
                       ...
                       >
                        Automation & Competeion with minimal effort
                    </p>
                    ...
                    <p className={cn(
                       ...
                       >
                        Axis UI allows you to automate your day to day tasks and should bring you convenience.
                    </p>
                </div>
